# Generated by Django 4.2.6 on 2024-02-02 14:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fecha_vigente",
                    models.DateField(
                        blank=True, null=True, verbose_name="Fecha Vigente"
                    ),
                ),
                (
                    "estadoVigencia",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "usuario",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="tiempo.usuario"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "canal",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="tiempo.canal"
                    ),
                ),
                (
                    "usuario",
        ...
        migrations.AddField(
            ...
            name="usuarios",
            field=models.ManyToManyField(
                blank=True, through="tiempo.CanalUsuario", to="tiempo.usuario"
            ),
        ),
    ]
